 ...
 * actually known.
 */
public final class UnknownHandlerException extends RuntimeException {

    private final HandlerRef ref;

    public UnknownHandlerException(HandlerRef ref) {
        super("unknown handler: " + ref);
        this.ref = ref;
    }

    public HandlerRef ref() {
        return ref;
    }
}
