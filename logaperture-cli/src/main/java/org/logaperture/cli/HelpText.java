...
final class HelpText {
    ...
    static String usage() {
        ...
        sb.append("\n");
        sb.append("A <target> for debug/trace/info/warn/error/set is an exact logger name,\n");
        ...
        sb.append("trailing-* target ('org.apache.*') is rejected for these commands --\n");
        sb.append("every descendant already inherits a set ancestor's level from the\n");
        sb.append("logging framework itself, so 'logctl debug org.apache' alone covers\n");
