...
**Shipped.** [`doc/specs/reset-command-surface.md`](specs/reset-command-surface.md), all six design decisions resolved and implemented — same treatment as §18.7's slices above. Summary below; that document is the source of truth for the full design and testing detail.
